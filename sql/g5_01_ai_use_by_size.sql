-- G5-01: descriptive AI-use estimates by published business-size group.
-- D-009-approved processed data only. Large businesses are a benchmark.
-- This query describes point estimates and intervals; it does not test differences.
...
WHERE o.indicator_id = 'uses_any_ai_based_technologies'
  AND o.source_table_id = '42'
  AND o.denominator_id = 'all_uk_businesses'
